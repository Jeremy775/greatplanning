 ...
 */
final class Version20220421105750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaires ADD user_id INT DEFAULT NULL, ADD created_at DATETIME NOT NULL, ADD auteur VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaires DROP user_id, DROP created_at, DROP auteur');
    }
}
